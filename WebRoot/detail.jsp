...
<meta name="author" content="order by dede58.com/" /><title>成理房缘</title>
...
<body> 
 ...
 <div class="logo-phone">
  <div class="width1190">
   <h1 class="logo"><a href="index.html"><img src="images/logo03.png" width="163" height="59" /></a></h1>
   <div class="clears"></div>
  </div><!--width1190/-->
 </div><!--logo-phone/-->
 <div class="list-nav">
 ...
 <div class="banner" style="background:url(images/banner01.jpg) center center no-repeat;"></div>
 ...
 <div class="content">
  <div class="width1190" style="width:1000px;">
   ...
   <div class="proText fr">
    <h3 class="proTitle">${tblUser.uname} </h3>
    <div class="proText1">
    ...
    <div class="xun-car">
     <a href="javascript:;" class="xwjg">¥<strong>${tblFwxx.zj}</strong>元</a>
    </div><!--xun-car/-->
   </div><!--proText/-->
   <div class="clears"></div>
  </div><!--width1190/-->
...
<br />
 ...
 <img src="images/fang1.jpg" /><img src="images/fang2.jpg" /><img src="images/fang3.jpg" /><img src="images/fang4.jpg" /><img src="images/fang5.jpg" /><img src="images/fang6.jpg" /><img src="images/fang7.jpg" /><img src="images/fang8.jpg" />
  ...
  <div class="proList">
   ...
   <input id="problem" name="problem" type="text" style="line-height: 30px;height: 30px;width: 415px;padding: 4px;bottom: 70px;left: 200px;" value placeholder="请输入问题内容" />
   <a href="javascript:;" class="xwjg1" style="line-height: 48px;bottom: 66px;left: 649px;" onclick="problem()">发布问题</a>
   </div>
					...
					if(id == null || id == '' || id == 0){
						...
						if(problem == "" || problem == null){
							layer.msg(decodeURI("请输入留言内容"));
								...
								location.href = '${WebPath }/index/saveSuggest.action?problem='+problem;
					    }
				    }
				}
 </script>
